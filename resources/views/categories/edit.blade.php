...
<body class="text-gray-900 dark:text-white min-h-screen">
    ...
    <div class="bg-white dark:bg-gray-800 p-4 sm:p-5 lg:p-6 w-full border-b border-gray-200 dark:border-gray-700">
        ...
        <!-- Header -->
        <div class="mb-6 sm:mb-8 lg:mb-10 pb-4 border-b border-gray-200 dark:border-gray-700 flex items-center">
            ...
            <h1 class="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight">
        ...
        <form action="{{ route('categories.update', $category) }}" method="POST" class="space-y-8">
            ...
            <div class="bg-gray-700/50 p-6 rounded-xl shadow-lg border border-gray-600 hover:border-emerald-500 transition-all duration-300">
                <label for="name" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Nombre de la Categoría</label>
                ...
                <input type="text" 
                    ...
                    required 
                    class="w-full px-4 py-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-emerald-500/50 focus:border-emerald-500 transition-colors shadow-inner">
