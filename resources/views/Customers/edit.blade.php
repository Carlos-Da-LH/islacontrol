...
<body class="min-h-screen">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden p-4 sm:p-5 lg:p-6 w-full border-b border-gray-200 dark:border-gray-700">

            <!-- Título con Icono SVG -->
            <div class="flex flex-col sm:flex-row items-center justify-center mb-6 sm:mb-8 lg:mb-10 border-b border-gray-200 dark:border-gray-700 pb-4 gap-2">
                ...
                <h1 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 dark:text-white text-center">
                    Editar Cliente
                </h1>
            </div>
            ...
            <form action="{{ route('customers.update', $customer->id) }}" method="POST" class="p-8 border border-gray-200 dark:border-gray-700 rounded-xl bg-gray-900 shadow-xl">
                @csrf
                @method('PUT') 
                
                <h2 class="text-2xl font-bold text-green-400 mb-6 border-b border-gray-200 dark:border-gray-700 pb-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <!-- Campo Teléfono -->
                    <div>
                        <label for="phone_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Teléfono</label>
                ...
                <div class="mt-8 flex justify-end gap-4 items-center">
                    ...
                    <a href="{{ route('customers.index') }}" 
                        class="py-3 px-6 text-base font-medium rounded-lg text-gray-700 dark:text-gray-300 bg-gray-700 hover:bg-gray-600 
